...
export declare function deriveWindowKey(srk: Uint8Array, windowIndex: bigint): Buffer
export declare function generateVerificationCode(keyA: Uint8Array, keyB: Uint8Array, conversationId: Uint8Array): string
export declare function computeFingerprint(keyA: Uint8Array, keyB: Uint8Array, conversationId: Uint8Array): Buffer
export declare function verifyFingerprintsMatch(fingerprintA: Uint8Array, fingerprintB: Uint8Array): boolean
...
export declare function authenticatedKemEncapsulate(ourX25519Sk: Uint8Array, recipientX25519Pub: Uint8Array, recipientMlkemPub: Uint8Array, senderIdentitySk: Uint8Array): Array<Buffer>
...
export declare function registryAddDevice(registryJson: string, deviceId: string, name: string, addedAt: bigint, publicKey: string): string
...
export declare function ratchetSrk(currentSrk: Uint8Array, ourRatchetSecret: Uint8Array, theirRatchetPub: Uint8Array, chatId: Uint8Array, ratchetStep: bigint, isSender: boolean): Buffer
...
export declare function transcriptComputeMessageHash(messageId: Uint8Array, senderId: Uint8Array, timestamp: bigint, ciphertext: Uint8Array): Buffer
...
export declare function keyLogCreateEntry(userId: Uint8Array, publicKey: Uint8Array, timestamp: bigint, prevEntryHash: Uint8Array, action: number, signingKey: Uint8Array): string
