...
/* auto-generated by NAPI-RS — manual additions for JS-side functions below */
...
export declare function initializeLicense(config?: LicenseConfig): Promise<LicenseStatus>
export declare function getLicenseStatus(): LicenseStatus | null
export declare function trackLicensedUser(userId: string): void
export declare function destroyLicenseTracker(): void
