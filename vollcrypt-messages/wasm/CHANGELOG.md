...
- Promoted the hardened Messages Node and WebAssembly bindings to the stable 1.0 release line.
- Aligned Rust crate, npm package, lockfile, and generated WebAssembly package versions.
