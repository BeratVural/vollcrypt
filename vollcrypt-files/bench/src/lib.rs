...
impl SystemMonitor {
    ...
    pub fn stop(mut self) -> (f64, f64, f64, f64, f64, f64, f64, f64, f64, f64, f64, f64) {
        ...
        (
            ...
            max(&s.cpu_usage_pct),
            avg(&s.cpu_usage_pct),
            min(&s.disk_read_bytes_per_sec),
            max(&s.disk_read_bytes_per_sec),
            avg(&s.disk_read_bytes_per_sec),
            min(&s.disk_write_bytes_per_sec),
            max(&s.disk_write_bytes_per_sec),
            avg(&s.disk_write_bytes_per_sec),
        )
    }
}
